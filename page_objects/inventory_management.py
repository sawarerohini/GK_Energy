...
class Inventary_Management(Base):
    def __init__(self, driver):
        super().__init__(driver)
        self.driver = driver

        self.inventory_management_link = (By.XPATH, "//a[@href='/dashboard/inventory-management']")
        self.state_drp = (By.ID, "state")
        ...
        self.result_table_row = (By.XPATH,"Mauda/html[1]/body[1]/app-root[1]/app-dashboard[1]/app-inventory-management[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/table[1]/tbody[1]/tr[1]/td[2]")

    def click_inventory_management_link(self):
        self.click_element(*self.inventory_management_link)
        time.sleep(3)
