...
class Survey_Report(Base):
    def __init__(self, driver):
        super().__init__(driver)
        self.driver = driver

        self.survey_report_link = (By.XPATH, "//a[@href='/dashboard/survey-report']")
        self.state_drp = (By.XPATH, "//select[@id='state']")
        self.district_drp = (By.XPATH, "//select[@id='district']")
        self.taluka_drp = (By.XPATH, "//select[@id='taluka']")
        self.search_btn = (By.XPATH, "//button[@class='btn btn-primary btn-outline-primary mtt-44 mx-2']")
        self.result_table_row = (By.XPATH,"/html[1]/body[1]/app-root[1]/app-dashboard[1]/app-survey_report[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/table[1]/tbody[1]/tr[1]/td[4]")

    def click_survey_report_link(self):
        self.click_element(*self.survey_report_link)
        time.sleep(3)
    ...
    #     self.wait_for_element_to_be_visible(By.ID, 'resultTable')
    #
    ...
    #     for row in rows:
    #         row_text = row.text
    #         print(f"Row text: {row_text}")  # Print row text for debugging purposes
    ...
    # def wait_for_element_to_be_visible(self, param):
    #     pass